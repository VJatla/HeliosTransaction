function Helios_UNet(train_imds, train_pxds,...
                                test_imds,...
                                test_pxds,...
                                train_flag)
...
if (train_flag)
    ...
    imageSize       = [360 720];
    numClasses      = 3;
    % FilterSize = 3 as proposed in https://arxiv.org/pdf/1505.04597.pdf
    % NumOutputChannels: 64 as proposed in paper.
    lgraph          = unetLayers(imageSize,numClasses,...
                                    'EncoderDepth',3);
    save('lgraph','lgraph');
    pximds          = pixelLabelImageDatastore(imds,pxds);
    % Unet seem to require very slow learning rate. Faster learning
    % rate tent to not converge.
