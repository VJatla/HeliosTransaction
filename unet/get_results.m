...
if isunix
    ...
    gt_dir = '../Data/R8_png/';
    seg_dir = "segmented_images/testing";
elseif ispc
    test_cyc1_csv = strcat("..\TrainTest_split","\","cycle_one_test.csv");
    test_cyc2_csv = strcat("..\TrainTest_split","\","cycle_two_test.csv");
    gt_dir = '..\Data\R8_png\';
    seg_dir = "segmented_images\testing";
end
...
for i = 1:size(test_tbl,1)
    ...
    cur_seg  = imread(seg_dir+"/"+"synoptic_GONG_"+string(cur_date)+".png");
...
writetable(prf_tb, "performance.csv");
