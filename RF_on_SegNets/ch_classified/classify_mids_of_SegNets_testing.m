...
elseif isunix
    SegNets_seg_dir = '../../segnets_30test_70train/segmented_images/testing';
...
elseif ispc
    SegNets_seg_dir = '..\..\segnets_30test_70train\segmented_images\testing';
    classifier_dir       = '..\rf_model';
    gt_dir          = '..\..\..\..\Data\R8_png';
    syn_dir            = '..\..\Data\synoptic_png\';
    mag_dir            = '..\..\Data\photomap\';
...
for rowidx = 1:size(test_tbl,1)
    ...
    imwrite(h_new,"segmented_images/"+string(cur_date)+".png");
