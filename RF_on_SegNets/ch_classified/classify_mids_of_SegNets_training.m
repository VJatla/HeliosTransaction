...
elseif isunix
    SegNets_seg_dir = '../../segnets_30test_70train/segmented_images/training';
...
elseif ispc
    SegNets_seg_dir = '..\..\segnets_30test_70train\segmented_images\training';
    classifier_dir       = '..\rf_model';
    gt_dir          = '..\..\..\..\Data\R8_png';
    syn_dir            = '..\..\Data\synoptic_png\';
    mag_dir            = '..\..\Data\photomap\';
...
for rowidx = 1:size(train_tbl,1)
    ...
    h_img   = double(read_image(SegNets_seg_dir, cur_date));
    ...
    imwrite(h_new,"segmented_images/training/"+string(cur_date)+".png");
...
function valid_img = get_valid_non_overlap_mids(img, cur_date,...
                                                mdl_dir,mag_dir,...
                                                syn_dir)
% trains each coronal hole for validity using classifier trained
% on other dates.
