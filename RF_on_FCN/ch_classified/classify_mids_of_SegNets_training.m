...
elseif isunix
    FCN_seg_dir = '../../fcn8_30test_70train/segmented_images/training';
...
elseif ispc
    FCN_seg_dir = '..\..\fcn8_30test_70train\segmented_images\training';
    classifier_dir       = '..\rf_model';
    gt_dir          = '..\..\..\..\Data\R8_png';
    syn_dir            = '..\..\Data\synoptic_png\';
    mag_dir            = '..\..\Data\photomap\';
...
for rowidx = 1:size(train_tbl,1)
    ...
    h_img   = double(read_image(FCN_seg_dir, cur_date));
