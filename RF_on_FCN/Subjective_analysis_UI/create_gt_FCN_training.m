...
subject_dir  = "FCN_gt/"+subject_name;
...
elseif isunix
    ...
    fcn_dir = '../../fcn8_30test_70train/segmented_images/training';
...
elseif ispc
    ...
    gt_dir          = '..\..\Data\R8_png';
    syn_dir         = '..\..\Data\synoptic_png';
    fcn_dir = '..\..\fcn8_30test_70train\segmented_images\training';
    train_cyc1_csv = strcat("..\..\TrainTest_split","\","cycle_one_train.csv");
    train_cyc2_csv = strcat("..\..\TrainTest_split","\","cycle_two_train.csv");
else
...
for rowidx = 1:size(train_tbl,1)
    ...
    s_img   = double(read_image(fcn_dir, cur_date));
    ...
    imwrite(labelled_img, subject_dir+"/fcn_gt_"+cur_date+".png")
